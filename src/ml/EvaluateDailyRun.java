 ...
 * Name of file is libsvm+organ+.model
 * or from database as well
 * */

public class EvaluateDailyRun {
    ...
    EvaluateDailyRun(String organ, String instance_key, String runtype)
    {
        try {
